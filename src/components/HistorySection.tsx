        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="prose prose-emerald max-w-none dark:prose-invert">
              ...
              <blockquote className="italic border-l-4 border-emerald-500 pl-4 my-6 text-gray-700 dark:text-gray-300">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <a 
                href="#"
                className="flex items-center justify-center bg-emerald-100 dark:bg-emerald-900 hover:bg-emerald-200 dark:hover:bg-emerald-800 text-emerald-800 dark:text-emerald-100 py-3 px-4 rounded-lg transition-colors"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-xl">
                ...
                <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Compositores</h4>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-xl">
                ...
                <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Partitura Original</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-xl">
                ...
                <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Reconhecimento</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-5 rounded-xl">
                ...
                <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Localização</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
